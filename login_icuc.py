...
class icuc_spider:
    ...
    def login(self):
        ...
        elem_user = self.driver.find_element_by_name("casYhm_text")
        elem_pwd = self.driver.find_element_by_name("casMm_text")

        elem_user.send_keys("201811123011")
        elem_pwd.send_keys("0430ymli")
